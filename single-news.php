...
<div class="article">
	...
	<section class="news" id="autopage">
		...
		foreach ($raw_cat as $raw) {
			...
			<div class="main">
				<h3><?php the_title()?></h3>
				<p><?php echo get_the_date()?><?php if(!empty($cat)):?> | <?php foreach($cat as $c):?><a href="<?php bloginfo('url')?>/news/<?php echo $c->category_nicename?>/"><?php echo $c->name?></a> <?php endforeach;endif;?></p>
				<?php the_content()?>
